...
class ChaoticLSTM(nn.Module):
    ...
    def __init__(self, input_dim, hidden_dim, num_speakers, chaos_factor=3.9):
        ...
        self.feature_extractor = nn.Sequential(
            nn.Conv1d(1, 64, kernel_size=5, stride=2, padding=2),  # 降采样2倍
            nn.BatchNorm1d(64),
            nn.ReLU(),
            nn.MaxPool1d(2),  # 再降采样2倍
    ...
    def chaotic_activation(self, x):
        ...
        数学原理:
        chaotic_output = chaos_weight * x * (1 - x)

        特性:
        - 当chaos_weight ∈ [3.57, 4.0]时系统处于混沌状态
    ...
    def forward(self, x):
        ...
        chaotic_out = self.chaotic_activation(lstm_out_normalized)
